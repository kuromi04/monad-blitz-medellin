# RainbowKit EVM dApp — Reglas para Gemini

Aplica cuando el usuario diga **"usa RainbowKit con [chain]"** o construya una dApp EVM con wagmi + viem + RainbowKit.

> Coloca este contenido en un archivo `GEMINI.md` en la raíz del proyecto para que Gemini CLI o el plugin de VS Code Gemini lo tomen como contexto persistente.
